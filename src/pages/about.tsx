      ...
      <div className="container content">
        <Row>
          <Col md={8}>
            ...
            <p>
              ...
              I'm experienced in web development and have worked across a
              variety of stacks, in various industries. I started my career
              working in ASP.NET but have since transitioned into more
              JavaScript orientated positions. With that said, I am interested
              in any and all tech stacks but with a focus on JavaScript.
            </p>
            <p>
              ...
              (although they are still very much WIP and probably not very
              good).
            </p>
          </Col>
        </Row>
        ...
        <Row>
          <Col md={8}>
            ...
            <p>
              ...
              Flow. My day to day activities include building new features,
              fixing bugs, writing documentation, tests, etc. I am currently
              spearheading a push towards a micro-frontend architecture so this
              involves some high level design work, task scoping and plenty of
              planning. I also spend some time mentoring juniors, reviewing
              code, and presenting new features to product stakeholders.
            </p>
          </Col>
        </Row>
        <Row>
          <Col md={8}>
            ...
            <ul>
              ...
              <li>
                Assist in migration from classic MVC style UI architecture to
                Vue components
              </li>
              <li>
                Provide support to ensure maximum uptime including on call
                duties
              </li>
              <li>
              ...
              <li>
                Release management, including reviewing, merging and
                deployment•On call support, monitoring, escalation and issue
                resolution
              </li>
            </ul>
          </Col>
        ...
        <Row>
          <Col md={8}>
            ...
            <p>
              Startup incubator environment where moving fast and delivering
              were of upmost priority. Worked on two startup companies, building
              a platform for renting properties and lending money. Using Azure
              cloud technology with microservices architecture.
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                and follow up needs, scaling with a rapidly growing customer
                base. Generating email and sms messages on the fly, as customers
                moved through the apply process.
              </li>
              <li>
                CMS / Caseworking web application for managing customers & their
                journey throughout the product. Built using React and Flux.
                Integrated with existing microservices, including marketing,
                call center, etc.
              </li>
            </ul>
          </Col>
        ...
        <Row>
          <Col md={8}>
            ...
            <p>
              Digital agency serving the web needs of various charities across
              the UK.{" "}
            </p>
            <p>Responsibilities included</p>
            <ul>
              <li>
                Maintenance of Continuity CMS, used by LV Insurance. Python /
                .NET application. Building new features, writing new web
        ...
        <Row>
          <Col md={8}>
            ...
            <p>
              I am fanatical about Formula 1 and try to attend one race a year.
              So far I've been to Spa x2 and Hungary, absolutely fantastic
              events and a lot of fun.
            </p>
            <p>
              I practice meditation when I can and try to be mindful in
              everything I do (not always easy!).
            </p>
